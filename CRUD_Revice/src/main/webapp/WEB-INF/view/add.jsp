								...
								<form action="/student/addStudent" method="post"> 
									...
									<div class="form-outline mb-4">
										<label class="form-label" for="form3Example1cg">Your
											Name</label> <input type="text" id="form3Example1cg" name="studentName"
											class="form-control form-control-lg" />
									</div>

									<div class="form-outline mb-4">
										<label class="form-label" for="form3Example3cg">Marks</label>
										<input type="text" id="form3Example3cg" name="marks"
											class="form-control form-control-lg" />
									</div>

									<div class="form-outline mb-4">
										<label class="form-label" for="form3Example4cg">RollNo</label>
										<input type="text" id="form3Example4cg" name="studentRollNo"
											class="form-control form-control-lg" />
									</div>
