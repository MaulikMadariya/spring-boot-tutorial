								...
								<form action="/student/addStudent" method="post"> 
									...
									<div class="form-outline mb-4">
										<label class="form-label" for="form3Example1cg">Your
											Name</label> <input type="text" id="form3Example1cg" name="studentName" value="${data.studentName} "
											class="form-control form-control-lg" />
									</div>

									<div class="form-outline mb-4">
										<label class="form-label" for="form3Example3cg">Marks</label>
										<input type="text" id="form3Example3cg" name="marks" value="${data.marks} "
											class="form-control form-control-lg" />
									</div>

									<div class="form-outline mb-4">
										<label class="form-label" for="form3Example4cg">RollNo</label>
										<input type="text" id="form3Example4cg" name="studentRollNo" value="${data.studentRollNo} "
											class="form-control form-control-lg" />
									</div>
									...
									<div class="d-flex justify-content-center">
										...
										<button type="submit"
											class="btn btn-success btn-block btn-lg gradient-custom-4 text-body">Add Student</button>
									</div>
