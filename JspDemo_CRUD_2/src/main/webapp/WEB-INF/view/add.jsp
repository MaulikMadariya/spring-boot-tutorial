								...
								<form action="/addemp" method="post">
									...
									<div class="form-outline mb-4">
										<label class="form-label" for="form3Example3cg">Your
											Salary</label> <input type="text" id="form3Example3cg" name="salary"
											class="form-control form-control-lg" />
									</div>

									<div class="form-outline mb-4">
										<label class="form-label" for="form3Example4cg">Dept</label> <input
											type="text" id="form3Example4cg" name="dept" 
											class="form-control form-control-lg" />
									</div>
									<div class="form-outline mb-4">
										<label class="form-label" for="form3Example4cdg">Your
											Role</label> <input type="text" id="form3Example4cdg" name="role"
											class="form-control form-control-lg" />
									</div>
